        ...
        {confidenceOptions.map((option) => {
          ...
          return (
            <label
              key={option.value}
              htmlFor={inputId}
              className="flex min-h-12 cursor-pointer items-center gap-3 rounded-xl border border-slate-600 px-4 py-2 text-slate-100 transition has-checked:border-cyan-300 has-checked:bg-cyan-950 hover:border-cyan-300"
            >
              <input
                id={inputId}
                type="radio"
