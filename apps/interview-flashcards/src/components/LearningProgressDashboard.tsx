...
export function LearningProgressDashboard({ counts, totalCount, targetCount }: LearningProgressDashboardProps) {
  ...
  return (
    <section aria-labelledby="progress-heading" className="mb-6 rounded-3xl border border-slate-700 bg-slate-900 p-5 sm:p-6">
      ...
      <ul className="mt-4 grid grid-cols-2 gap-2 text-sm sm:grid-cols-5" aria-label="自信度の内訳">
